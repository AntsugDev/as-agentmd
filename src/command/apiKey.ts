...
import {ProvidersInt} from "../interface/myInterface.js";
        ...
        try {
            this.program.command('set-key').description('Set Api key for Providers')
                .action(() => {
                        ...
                        console.log(`${count}:None of the above; the provider must be created.[NON ESISTE IN QUESTQA VERSIONE]`)
                        ...
                        r.question("Select an providers from to list up:  ", (answer) => {
                            ...
                            const selected =this.providers[choice]
                            if (selected) {
                                r.question("Insert you api key: ", (answer2) => {
                                    ...
                                    if (apiKey) {
                                        ...
                                        configStore.set(`providers.${selected}`, p);
